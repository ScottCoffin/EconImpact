...
allSmalls.requested.voluntary.rest <- allSmalls.requested.voluntary %>% 
  select(-cash_reserve_total, -delinquent_num_acc, -delinquent_amount_dollars, -revenue_2020_Total, -revenue_2019_Total, -CES_3.0_Score, -Median_12month_HH_income, -months_before_assist )
#join
